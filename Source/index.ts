...
export { MAXIMAL_VALUE_OF_UNSIGNED_1_BYTE_INTEGER } from "./DataTypes/Integer/MAXIMAL_VALUE_OF_UNSIGNED_1_BYTE_INTEGER";
export { MAXIMAL_VALUE_OF_UNSIGNED_2_BYTES_INTEGER } from "./DataTypes/Integer/MAXIMAL_VALUE_OF_UNSIGNED_2_BYTES_INTEGER";
export { MAXIMAL_VALUE_OF_UNSIGNED_3_BYTES_INTEGER } from "./DataTypes/Integer/MAXIMAL_VALUE_OF_UNSIGNED_3_BYTES_INTEGER";
export { MAXIMAL_VALUE_OF_UNSIGNED_4_BYTES_INTEGER } from "./DataTypes/Integer/MAXIMAL_VALUE_OF_UNSIGNED_4_BYTES_INTEGER";
export { MAXIMAL_VALUE_OF_UNSIGNED_8_BYTES_INTEGER } from "./DataTypes/Integer/MAXIMAL_VALUE_OF_UNSIGNED_8_BYTES_INTEGER";
